...
public class BudgetsApi {
    ...
    /**
     * Build call for autoGenerateBudgets
     ...
     */
    public okhttp3.Call autoGenerateBudgetsCall(String userGuid, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call autoGenerateBudgetsValidateBeforeCall(String userGuid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userGuid' is set
        if (userGuid == null) {
            throw new ApiException("Missing the required parameter 'userGuid' when calling autoGenerateBudgets(Async)");
        }

        return autoGenerateBudgetsCall(userGuid, _callback);
    ...
    public BudgetResponseBody autoGenerateBudgets(String userGuid) throws ApiException {
        ApiResponse<BudgetResponseBody> localVarResp = autoGenerateBudgetsWithHttpInfo(userGuid);
    ...
    public ApiResponse<BudgetResponseBody> autoGenerateBudgetsWithHttpInfo(String userGuid) throws ApiException {
        okhttp3.Call localVarCall = autoGenerateBudgetsValidateBeforeCall(userGuid, null);
     ...
     */
    public okhttp3.Call autoGenerateBudgetsAsync(String userGuid, final ApiCallback<BudgetResponseBody> _callback) throws ApiException {

        okhttp3.Call localVarCall = autoGenerateBudgetsValidateBeforeCall(userGuid, _callback);
        Type localVarReturnType = new TypeToken<BudgetResponseBody>(){}.getType();
     ...
     */
    public okhttp3.Call createBudgetCall(String userGuid, BudgetCreateRequestBody budgetCreateRequestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createBudgetValidateBeforeCall(String userGuid, BudgetCreateRequestBody budgetCreateRequestBody, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userGuid' is set
        if (userGuid == null) {
        ...
        return createBudgetCall(userGuid, budgetCreateRequestBody, _callback);
    ...
    public BudgetResponseBody createBudget(String userGuid, BudgetCreateRequestBody budgetCreateRequestBody) throws ApiException {
        ApiResponse<BudgetResponseBody> localVarResp = createBudgetWithHttpInfo(userGuid, budgetCreateRequestBody);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<BudgetResponseBody> createBudgetWithHttpInfo(String userGuid, BudgetCreateRequestBody budgetCreateRequestBody) throws ApiException {
        okhttp3.Call localVarCall = createBudgetValidateBeforeCall(userGuid, budgetCreateRequestBody, null);
        Type localVarReturnType = new TypeToken<BudgetResponseBody>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call createBudgetAsync(String userGuid, BudgetCreateRequestBody budgetCreateRequestBody, final ApiCallback<BudgetResponseBody> _callback) throws ApiException {

        okhttp3.Call localVarCall = createBudgetValidateBeforeCall(userGuid, budgetCreateRequestBody, _callback);
        Type localVarReturnType = new TypeToken<BudgetResponseBody>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call deleteBudgetCall(String userGuid, String budgetGuid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteBudgetValidateBeforeCall(String userGuid, String budgetGuid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userGuid' is set
        if (userGuid == null) {
        ...
        return deleteBudgetCall(userGuid, budgetGuid, _callback);
    ...
    public ApiResponse<Void> deleteBudgetWithHttpInfo(String userGuid, String budgetGuid) throws ApiException {
        okhttp3.Call localVarCall = deleteBudgetValidateBeforeCall(userGuid, budgetGuid, null);
     ...
     */
    public okhttp3.Call deleteBudgetAsync(String userGuid, String budgetGuid, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteBudgetValidateBeforeCall(userGuid, budgetGuid, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for listAllBudgets
     * @param userGuid The unique identifier for a &#x60;user&#x60;, beginning with the prefix &#x60;USR-&#x60;. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call listAllBudgetsCall(String userGuid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAllBudgetsValidateBeforeCall(String userGuid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userGuid' is set
        if (userGuid == null) {
            throw new ApiException("Missing the required parameter 'userGuid' when calling listAllBudgets(Async)");
        }

        return listAllBudgetsCall(userGuid, _callback);
    ...
    public BudgetResponseBody listAllBudgets(String userGuid) throws ApiException {
        ApiResponse<BudgetResponseBody> localVarResp = listAllBudgetsWithHttpInfo(userGuid);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<BudgetResponseBody> listAllBudgetsWithHttpInfo(String userGuid) throws ApiException {
        okhttp3.Call localVarCall = listAllBudgetsValidateBeforeCall(userGuid, null);
        Type localVarReturnType = new TypeToken<BudgetResponseBody>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call listAllBudgetsAsync(String userGuid, final ApiCallback<BudgetResponseBody> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAllBudgetsValidateBeforeCall(userGuid, _callback);
        Type localVarReturnType = new TypeToken<BudgetResponseBody>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for readSpecificBudget
     * @param userGuid The unique identifier for a &#x60;user&#x60;, beginning with the prefix &#x60;USR-&#x60;. (required)
     * @param budgetGuid The unique identifier for the budget. Defined by MX. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call readSpecificBudgetCall(String userGuid, String budgetGuid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call readSpecificBudgetValidateBeforeCall(String userGuid, String budgetGuid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userGuid' is set
        if (userGuid == null) {
        ...
        return readSpecificBudgetCall(userGuid, budgetGuid, _callback);
    ...
    public BudgetResponseBody readSpecificBudget(String userGuid, String budgetGuid) throws ApiException {
        ApiResponse<BudgetResponseBody> localVarResp = readSpecificBudgetWithHttpInfo(userGuid, budgetGuid);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<BudgetResponseBody> readSpecificBudgetWithHttpInfo(String userGuid, String budgetGuid) throws ApiException {
        okhttp3.Call localVarCall = readSpecificBudgetValidateBeforeCall(userGuid, budgetGuid, null);
        Type localVarReturnType = new TypeToken<BudgetResponseBody>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call readSpecificBudgetAsync(String userGuid, String budgetGuid, final ApiCallback<BudgetResponseBody> _callback) throws ApiException {

        okhttp3.Call localVarCall = readSpecificBudgetValidateBeforeCall(userGuid, budgetGuid, _callback);
        Type localVarReturnType = new TypeToken<BudgetResponseBody>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updateSpecificBudget
     * @param userGuid The unique identifier for a &#x60;user&#x60;, beginning with the prefix &#x60;USR-&#x60;. (required)
     * @param budgetGuid The unique identifier for the budget. Defined by MX. (required)
     ...
     */
    public okhttp3.Call updateSpecificBudgetCall(String userGuid, String budgetGuid, BudgetUpdateRequestBody budgetUpdateRequestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSpecificBudgetValidateBeforeCall(String userGuid, String budgetGuid, BudgetUpdateRequestBody budgetUpdateRequestBody, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userGuid' is set
        if (userGuid == null) {
        ...
        return updateSpecificBudgetCall(userGuid, budgetGuid, budgetUpdateRequestBody, _callback);
    ...
    public BudgetResponseBody updateSpecificBudget(String userGuid, String budgetGuid, BudgetUpdateRequestBody budgetUpdateRequestBody) throws ApiException {
        ApiResponse<BudgetResponseBody> localVarResp = updateSpecificBudgetWithHttpInfo(userGuid, budgetGuid, budgetUpdateRequestBody);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<BudgetResponseBody> updateSpecificBudgetWithHttpInfo(String userGuid, String budgetGuid, BudgetUpdateRequestBody budgetUpdateRequestBody) throws ApiException {
        okhttp3.Call localVarCall = updateSpecificBudgetValidateBeforeCall(userGuid, budgetGuid, budgetUpdateRequestBody, null);
        Type localVarReturnType = new TypeToken<BudgetResponseBody>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateSpecificBudgetAsync(String userGuid, String budgetGuid, BudgetUpdateRequestBody budgetUpdateRequestBody, final ApiCallback<BudgetResponseBody> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSpecificBudgetValidateBeforeCall(userGuid, budgetGuid, budgetUpdateRequestBody, _callback);
        Type localVarReturnType = new TypeToken<BudgetResponseBody>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
