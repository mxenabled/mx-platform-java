...
public class AccountNumberResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountGuid, accountNumber, guid, institutionNumber, loanGuarantor, loanReferenceNumber, memberGuid, passedValidation, routingNumber, sequenceNumber, transitNumber, userGuid);
  }
