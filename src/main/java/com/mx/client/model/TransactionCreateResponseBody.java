...
public class TransactionCreateResponseBody {
  ...
  public TransactionCreateResponseBody accountGuid(String accountGuid) {
  ...
  **/
  ...
  public TransactionCreateResponseBody accountId(String accountId) {
  ...
  **/
  ...
  public TransactionCreateResponseBody amount(BigDecimal amount) {
  ...
  **/
  ...
  public TransactionCreateResponseBody category(String category) {
  ...
  **/
  ...
  public TransactionCreateResponseBody categoryGuid(String categoryGuid) {
  ...
  **/
  ...
  public TransactionCreateResponseBody checkNumberString(String checkNumberString) {
  ...
  **/
  ...
  public TransactionCreateResponseBody createdAt(String createdAt) {
  ...
  **/
  ...
  public TransactionCreateResponseBody currencyCode(String currencyCode) {
  ...
  **/
  ...
  public TransactionCreateResponseBody date(String date) {
  ...
  **/
  ...
  public TransactionCreateResponseBody description(String description) {
  ...
  **/
  ...
  public TransactionCreateResponseBody extendedTransactionType(String extendedTransactionType) {
  ...
  **/
  ...
  public TransactionCreateResponseBody guid(String guid) {
  ...
  **/
  ...
  public TransactionCreateResponseBody id(String id) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isBillPay(Boolean isBillPay) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isDirectDeposit(Boolean isDirectDeposit) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isExpense(Boolean isExpense) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isFee(Boolean isFee) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isIncome(Boolean isIncome) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isInternational(Boolean isInternational) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isManual(Boolean isManual) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isOverdraftFee(Boolean isOverdraftFee) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isPayrollAdvance(Boolean isPayrollAdvance) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isRecurring(Boolean isRecurring) {
  ...
  **/
  ...
  public TransactionCreateResponseBody isSubscription(Boolean isSubscription) {
  ...
  **/
  ...
  public TransactionCreateResponseBody latitude(BigDecimal latitude) {
  ...
  **/
  ...
  public TransactionCreateResponseBody localizedDescription(String localizedDescription) {
  ...
  **/
  ...
  public TransactionCreateResponseBody localizedMemo(String localizedMemo) {
  ...
  **/
  ...
  public TransactionCreateResponseBody longitude(BigDecimal longitude) {
  ...
  **/
  ...
  public TransactionCreateResponseBody memberGuid(String memberGuid) {
  ...
  **/
  ...
  public TransactionCreateResponseBody memberIsManagedByUser(Boolean memberIsManagedByUser) {
  ...
  **/
  ...
  public TransactionCreateResponseBody memo(String memo) {
  ...
  **/
  ...
  public TransactionCreateResponseBody merchantCategoryCode(Integer merchantCategoryCode) {
  ...
  **/
  ...
  public TransactionCreateResponseBody merchantGuid(String merchantGuid) {
  ...
  **/
  ...
  public TransactionCreateResponseBody merchantLocationGuid(String merchantLocationGuid) {
  ...
  **/
  ...
  public TransactionCreateResponseBody metadata(String metadata) {
  ...
  **/
  ...
  public TransactionCreateResponseBody originalDescription(String originalDescription) {
  ...
  **/
  ...
  public TransactionCreateResponseBody postedAt(String postedAt) {
  ...
  **/
  ...
  public TransactionCreateResponseBody status(String status) {
  ...
  **/
  ...
  public TransactionCreateResponseBody topLevelCategory(String topLevelCategory) {
  ...
  **/
  ...
  public TransactionCreateResponseBody transactedAt(String transactedAt) {
  ...
  **/
  ...
  public TransactionCreateResponseBody type(String type) {
  ...
  **/
  ...
  public TransactionCreateResponseBody updatedAt(String updatedAt) {
  ...
  **/
  ...
  public TransactionCreateResponseBody userGuid(String userGuid) {
  ...
  **/
  ...
  public TransactionCreateResponseBody userId(String userId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TransactionCreateResponseBody transactionCreateResponseBody = (TransactionCreateResponseBody) o;
    return Objects.equals(this.accountGuid, transactionCreateResponseBody.accountGuid) &&
        Objects.equals(this.accountId, transactionCreateResponseBody.accountId) &&
        Objects.equals(this.amount, transactionCreateResponseBody.amount) &&
        Objects.equals(this.category, transactionCreateResponseBody.category) &&
        Objects.equals(this.categoryGuid, transactionCreateResponseBody.categoryGuid) &&
        Objects.equals(this.checkNumberString, transactionCreateResponseBody.checkNumberString) &&
        Objects.equals(this.createdAt, transactionCreateResponseBody.createdAt) &&
        Objects.equals(this.currencyCode, transactionCreateResponseBody.currencyCode) &&
        Objects.equals(this.date, transactionCreateResponseBody.date) &&
        Objects.equals(this.description, transactionCreateResponseBody.description) &&
        Objects.equals(this.extendedTransactionType, transactionCreateResponseBody.extendedTransactionType) &&
        Objects.equals(this.guid, transactionCreateResponseBody.guid) &&
        Objects.equals(this.id, transactionCreateResponseBody.id) &&
        Objects.equals(this.isBillPay, transactionCreateResponseBody.isBillPay) &&
        Objects.equals(this.isDirectDeposit, transactionCreateResponseBody.isDirectDeposit) &&
        Objects.equals(this.isExpense, transactionCreateResponseBody.isExpense) &&
        Objects.equals(this.isFee, transactionCreateResponseBody.isFee) &&
        Objects.equals(this.isIncome, transactionCreateResponseBody.isIncome) &&
        Objects.equals(this.isInternational, transactionCreateResponseBody.isInternational) &&
        Objects.equals(this.isManual, transactionCreateResponseBody.isManual) &&
        Objects.equals(this.isOverdraftFee, transactionCreateResponseBody.isOverdraftFee) &&
        Objects.equals(this.isPayrollAdvance, transactionCreateResponseBody.isPayrollAdvance) &&
        Objects.equals(this.isRecurring, transactionCreateResponseBody.isRecurring) &&
        Objects.equals(this.isSubscription, transactionCreateResponseBody.isSubscription) &&
        Objects.equals(this.latitude, transactionCreateResponseBody.latitude) &&
        Objects.equals(this.localizedDescription, transactionCreateResponseBody.localizedDescription) &&
        Objects.equals(this.localizedMemo, transactionCreateResponseBody.localizedMemo) &&
        Objects.equals(this.longitude, transactionCreateResponseBody.longitude) &&
        Objects.equals(this.memberGuid, transactionCreateResponseBody.memberGuid) &&
        Objects.equals(this.memberIsManagedByUser, transactionCreateResponseBody.memberIsManagedByUser) &&
        Objects.equals(this.memo, transactionCreateResponseBody.memo) &&
        Objects.equals(this.merchantCategoryCode, transactionCreateResponseBody.merchantCategoryCode) &&
        Objects.equals(this.merchantGuid, transactionCreateResponseBody.merchantGuid) &&
        Objects.equals(this.merchantLocationGuid, transactionCreateResponseBody.merchantLocationGuid) &&
        Objects.equals(this.metadata, transactionCreateResponseBody.metadata) &&
        Objects.equals(this.originalDescription, transactionCreateResponseBody.originalDescription) &&
        Objects.equals(this.postedAt, transactionCreateResponseBody.postedAt) &&
        Objects.equals(this.status, transactionCreateResponseBody.status) &&
        Objects.equals(this.topLevelCategory, transactionCreateResponseBody.topLevelCategory) &&
        Objects.equals(this.transactedAt, transactionCreateResponseBody.transactedAt) &&
        Objects.equals(this.type, transactionCreateResponseBody.type) &&
        Objects.equals(this.updatedAt, transactionCreateResponseBody.updatedAt) &&
        Objects.equals(this.userGuid, transactionCreateResponseBody.userGuid) &&
        Objects.equals(this.userId, transactionCreateResponseBody.userId);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransactionCreateResponseBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionCreateResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionCreateResponseBody is not found in the empty JSON string", TransactionCreateResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransactionCreateResponseBody.openapiFields.contains(entry.getKey())) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionCreateResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionCreateResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionCreateResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionCreateResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionCreateResponseBody>() {
           @Override
           public void write(JsonWriter out, TransactionCreateResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransactionCreateResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TransactionCreateResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionCreateResponseBody
  * @throws IOException if the JSON string is invalid with respect to TransactionCreateResponseBody
  */
  public static TransactionCreateResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionCreateResponseBody.class);
  }

 /**
  * Convert an instance of TransactionCreateResponseBody to an JSON string
  *
  * @return JSON string
  */
