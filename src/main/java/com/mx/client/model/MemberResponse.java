...
public class MemberResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aggregatedAt, backgroundAggregationIsDisabled, connectionStatus, connectionStatusMessage, guid, id, institutionCode, institutionGuid, isBeingAggregated, isManagedByUser, isManual, isOauth, metadata, mostRecentJobDetailCode, mostRecentJobDetailText, mostRecentJobGuid, name, needsUpdatedCredentials, oauthWindowUri, successfullyAggregatedAt, useCases, userGuid, userId);
  }
