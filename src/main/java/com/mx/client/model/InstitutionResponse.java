...
public class InstitutionResponse {
  ...
  public static final String SERIALIZED_NAME_INSTRUCTIONAL_TEXT_STEPS = "instructional_text_steps";
  @SerializedName(SERIALIZED_NAME_INSTRUCTIONAL_TEXT_STEPS)
  private List<String> instructionalTextSteps;

  public static final String SERIALIZED_NAME_IS_DISABLED_BY_CLIENT = "is_disabled_by_client";
  @SerializedName(SERIALIZED_NAME_IS_DISABLED_BY_CLIENT)
  private Boolean isDisabledByClient;
  ...
  **/
  ...
  public InstitutionResponse instructionalTextSteps(List<String> instructionalTextSteps) {
    
    this.instructionalTextSteps = instructionalTextSteps;
    return this;
  }

  public InstitutionResponse addInstructionalTextStepsItem(String instructionalTextStepsItem) {
    if (this.instructionalTextSteps == null) {
      this.instructionalTextSteps = new ArrayList<>();
    }
    this.instructionalTextSteps.add(instructionalTextStepsItem);
    return this;
  }

   /**
   * An array of instructional steps that may contain html elements.
   * @return instructionalTextSteps
  **/
  @javax.annotation.Nullable
  public List<String> getInstructionalTextSteps() {
    return instructionalTextSteps;
  }


  public void setInstructionalTextSteps(List<String> instructionalTextSteps) {
    this.instructionalTextSteps = instructionalTextSteps;
  }


  public InstitutionResponse isDisabledByClient(Boolean isDisabledByClient) {
   ...
   /**
   * Get isDisabledByClient
   * @return isDisabledByClient
  **/
  @javax.annotation.Nullable
  public Boolean getIsDisabledByClient() {
    return isDisabledByClient;
  }


  public void setIsDisabledByClient(Boolean isDisabledByClient) {
    this.isDisabledByClient = isDisabledByClient;
  }


  public InstitutionResponse isoCountryCode(String isoCountryCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, institutionResponse.code) &&
        ...
        Objects.equals(this.instructionalTextSteps, institutionResponse.instructionalTextSteps) &&
        Objects.equals(this.isDisabledByClient, institutionResponse.isDisabledByClient) &&
        Objects.equals(this.isoCountryCode, institutionResponse.isoCountryCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, forgotPasswordUrl, forgotUsernameUrl, instructionalText, instructionalTextSteps, isDisabledByClient, isoCountryCode, mediumLogoUrl, name, smallLogoUrl, supportsAccountIdentification, supportsAccountStatement, supportsAccountVerification, supportsOauth, supportsTaxDocument, supportsTransactionHistory, troubleSigningInUrl, url);
  }
  ...
  public String toString() {
    ...
    sb.append("    instructionalTextSteps: ").append(toIndentedString(instructionalTextSteps)).append("\n");
    sb.append("    isDisabledByClient: ").append(toIndentedString(isDisabledByClient)).append("\n");
  ...
  static {
    ...
    openapiFields.add("instructional_text_steps");
    openapiFields.add("is_disabled_by_client");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("instructional_text_steps") != null && !jsonObj.get("instructional_text_steps").isJsonNull() && !jsonObj.get("instructional_text_steps").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `instructional_text_steps` to be an array in the JSON string but got `%s`", jsonObj.get("instructional_text_steps").toString()));
      }
