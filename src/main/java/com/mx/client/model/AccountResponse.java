...
public class AccountResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, apr, apy, availableBalance, availableCredit, balance, cashBalance, cashSurrenderValue, createdAt, creditLimit, currencyCode, dayPaymentIsDue, deathBenefit, guid, holdingsValue, id, institutionCode, insuredName, interestRate, isClosed, isHidden, lastPayment, lastPaymentAt, loanAmount, maturesOn, memberGuid, minimumBalance, minimumPayment, name, originalBalance, payOutAmount, paymentDueAt, payoffBalance, premiumAmount, startedOn, subtype, totalAccountValue, type, updatedAt, userGuid);
  }
